                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p onClick={() => window.location = 'tel: +91 540-025-124553'} className='tel'><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 540-025-124553 </p>
                                <p onClick={() => window.location = 'mailto:sale@Nest.com'} className='mail'><EmailOutlinedIcon /> <strong className=''>Email: </strong>sale@Nest.com </p>
                                ...
                                <div className='m-auto d-flex align-items-center phWrap'>
                                    <div className='phNo d-flex align-items-center mx-5'>
                                        ...
                                        <div className='info ml-3'>
                                            <h3 onClick={() => window.location = 'tel: 1900 - 888'} className='tel text-g mb-0 cursor-pointer'>1900 - 888</h3>
                                    ...
                                    <div className='phNo d-flex align-items-center  mx-5'>
                                        <span><HeadphonesOutlinedIcon /></span>
                                        <div className='tel info ml-3'>
                                            <h3 onClick={() => window.location = 'tel: 1900 - 888'} className='text-g mb-0 cursor-pointer'>1900 - 888</h3>
                                            <p className='mb-0'>24/7 Support Center</p>
                                        </div>
                                    </div>
                                </div>
