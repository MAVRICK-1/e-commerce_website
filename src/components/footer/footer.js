                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p onClick={() => window.location = 'tel: +91 540-025-124553'} className='cursor-pointer'><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 540-025-124553 </p>
                                <p onClick={() => window.location = 'mailto:sale@Nest.com'} className='cursor-pointer'><EmailOutlinedIcon /> <strong>Email:</strong> sale@Nest.com</p>
